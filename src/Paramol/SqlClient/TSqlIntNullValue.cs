...
namespace Paramol.SqlClient
{
    ...
    /// </summary>
    public class TSqlIntNullValue : IDbParameterValue
    {
        /// <summary>
        ///     The single instance of this value.
        /// </summary>
        public static readonly TSqlIntNullValue Instance = new TSqlIntNullValue();

        private TSqlIntNullValue()
        {
        }
        ...
        private static bool Equals(TSqlIntNullValue value)
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj == null || obj.GetType() != GetType())
                return false;
            return Equals((TSqlIntNullValue) obj);
        }
