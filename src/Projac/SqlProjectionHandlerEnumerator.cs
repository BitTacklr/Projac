...
namespace Projac
{
    ...
    /// </summary>
    public class SqlProjectionHandlerEnumerator : IEnumerator<SqlProjectionHandler>
    {
        private readonly SqlProjectionHandler[] _handlers;
        private int _index;

        /// <summary>
        /// Initializes a new instance of the <see cref="SqlProjectionHandlerEnumerator"/> class.
        /// </summary>
        ...
        public SqlProjectionHandlerEnumerator(SqlProjectionHandler[] handlers)
        {
