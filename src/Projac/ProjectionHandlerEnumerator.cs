...
namespace Projac
{
    ...
    /// </summary>
    public class ProjectionHandlerEnumerator<TConnection> : IEnumerator<ProjectionHandler<TConnection>>
    {
        ...
        public ProjectionHandlerEnumerator(ProjectionHandler<TConnection>[] handlers)
        {
        ...
        /// </exception>
        public ProjectionHandler<TConnection> Current
        {
            get
            {
                if (_index == -1)
