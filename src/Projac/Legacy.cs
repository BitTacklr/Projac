...
namespace Projac
{
    ...
    /// </summary>
    [Obsolete("Please use one of the sql datatype specific null parameter values instead.")]
    ...
    public static partial class TSql
    {
        ...
        [Obsolete("Please use one of the sql datatype specific overloads that accepts null.")]
