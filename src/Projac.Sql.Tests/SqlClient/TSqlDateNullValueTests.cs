...
{
    [TestFixture]
    public class TSqlDateNullValueTests
    {
        private TSqlDateNullValue _sut;

        [SetUp]
        public void SetUp()
        {
            _sut = TSqlDateNullValue.Instance;
        }
        ...
        public void ToDbParameterReturnsExpectedInstance()
        {
            ...
            result.ExpectSqlParameter(parameterName, SqlDbType.Date, DBNull.Value, true);
        }
