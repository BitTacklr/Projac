...
{
    [TestFixture]
    public class TSqlNVarCharValueTests
    {
        [Test]
        public void NullIsNotAnAcceptableValue()
        {
            Assert.Throws<ArgumentNullException>(() => SutFactory(null, new TSqlNVarCharSize(123)));
        }
        ...
        public void IsSqlParameterValue()
        {
            ...
            Assert.That(sut, Is.InstanceOf<ITSqlParameterValue>());
        }
        ...
        public void ToSqlParameterReturnsExpectedInstance()
        {
            ...
            result.Expect(parameterName, SqlDbType.VarChar, value, false, 123);
        }
        ...
        private static TSqlNVarCharValue SutFactory()
        {
            return SutFactory("value", new TSqlNVarCharSize(123));
        }

        private static TSqlNVarCharValue SutFactory(string value, TSqlNVarCharSize size)
        {
