...
namespace Paramol.Tests.SqlClient
{
    ...
    public class ParameterCountLimitMaxed
    {
        public static readonly ParameterCountLimitMaxed Instance = new ParameterCountLimitMaxed();

        private ParameterCountLimitMaxed() { }
